  ...
  return (
    <footer style={{ marginTop: 'auto', zIndex: 10 }}>
      <div className="footer-inner">
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '14px' }}>
            ...
            <span style={{ fontFamily: 'var(--display)', fontSize: '1.05rem', color: 'var(--text-hi)', letterSpacing: '3px' }}>Credimatch<span style={{ color: 'var(--cyan)' }}>.</span></span>
          </div>
      ...
      <div className="footer-bar">
        <p>© 2026 Credimatch. ALL RIGHTS RESERVED · INDEPENDENT COMPARISON PLATFORM</p>
